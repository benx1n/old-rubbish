	...
	<view class="wrap">
		<u-form :model="model" :rules="rules" ref="uForm" :errorType="errorType">
			<u-form-item :label-position="labelPosition" prop="photo" label-width="150">
				<u-upload ref="uUpload" :file-list="fileList" :action="action" width="160" height="160" upload-text="上传书籍封面"></u-upload>
			</u-form-item>
			<u-form-item :leftIconStyle="{color: '#888', fontSize: '32rpx'}" label-width="120" :label-position="labelPosition"
			 label="书籍名称" prop="name">
				<u-input :border="border" placeholder="请输入书籍名称" v-model="model.name" type="text"></u-input>
			</u-form-item>
...
<script>
	export default {
		...
		onLoad(e) {
			...
			this.model.category=this.model.catory
			let json={}
			json.url=this.baseUrl+"/files/"+this.model.imageUrl
			this.fileList=[json]
